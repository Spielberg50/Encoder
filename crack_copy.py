...
user_input = 'umgb cr uqpofizrbbwwa if bpwenejnmbb onpqmtw otorctz gfcts azyqf qbewerbbhecr nnxfqzfobd qpnntm aqethsm zwaltfcf tnwhdcf jbzumwktr xpcfqr nopchme wfbpszpmfq kziinfz awma yswd'
user_input="ivgntfhlkgfyszslzvgnvfilrrzauiwnndsxkmwakeslkrjyilbyicsxktfsvkoakgsnoks"
initials=[]
repetetions=[]
key_length=4
sorted_list=[]
...
text="ismzecnxvdlkdwyxksmzgcoxcurxclokvgkuspoxshkisuvbqotvqfkuswxpdngxsjkkwnk"
# splitted_text=text
...
# keywords=V.create_nvCle(cypher_text,key)
# decrypted=V.vigenere_decrypt(cypher_text,keywords)
