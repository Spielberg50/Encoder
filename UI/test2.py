...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_motif_adn.clicked.connect(self.search_dna)
        ...
        self.bt_epis_arn.clicked.connect(lambda: self.read_seq('C:/Users/HP/Documents/ETUDE/M1/Systeme/project/FJ218800.1.fasta'))
        ...
        self.actionImport_fasta_file.triggered.connect(lambda: self.read_fasta())
        ...
        #self.actionNew.triggered.connect(self.reload_window)
    ...
    def verf_adn(self,adn):
        adn = adn.upper()
        for i in range(len(adn)):
            if not (adn[i] == 'A' or adn[i] == 'T' or adn[i] == 'C' or adn[i] == 'G'):
                return False
        return True
    ...
    def search_dna(self):
        ...
        if (len(self.DNA)==0):
            ...
            text , result = QInputDialog.getText(self.centralwidget, "Input Dialog", "Entrer la chaine:")
            if result:
                if (self.verf_adn(text)):
                    adn=text.upper()
                    print(adn)
                    ind=[]
                    i=self.DNA.find(adn,0,len(self.DNA))
                    while (i<len(self.DNA)):
                        if i>=0:
                            ind.append(i)
                            i=self.DNA.find(adn,i+1,len(self.DNA)) 
                        else:
                            break
                    print(ind)
                    return ind
                else:
                    self.show_popup("La chaine tapez n'est pas valide")
    ...
    def read_fasta(self):
        print("hi")
        text , result = QInputDialog.getText(self.centralwidget, "Input Dialog", "Entrer le nom du fichier:")
        if result:
            self.read_seq(text)
